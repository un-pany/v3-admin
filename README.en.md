...
![](assets/a727217bdfb84872a83d14d5be87a990tplv-k3u1fbpfcp-watermark.awebp)
...
![](assets/400ab6098b9c4fe28f3a3057cf0ce235tplv-k3u1fbpfcp-watermark.awebp)
...
```mermaid
graph LR
    1[Page/Interaction] --> 2[Unified management API] --> 3[Encapsulated service.ts] --> 4[Server]
```
